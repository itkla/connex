...
const ASCENT_START = { x: 721.609375, y: 637.96875 };
...
export function FujiBackdrop({ pauseLabel, resumeLabel }: { pauseLabel: string; resumeLabel: string }) {
    // Split the existing left ridge a quarter of the way up so the ascent starts low on the slope and still follows the exact silhouette.
    const ascentCurve = "C827.6875 570.375 928 486.75 1039 393";
    const leftSlope = `M160 846 C342 816 481 767 613 700 C650.25 681.25 686.25 660.5 ${ASCENT_START.x} ${ASCENT_START.y} ${ascentCurve}`;
