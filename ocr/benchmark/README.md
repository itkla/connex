...
export CONNEX_BENCHMARK_SESSION_COOKIE='SESSION=...; XSRF-TOKEN=...'
...
The command fails unless email and phone accuracy are at least 95%, name accuracy is at least 85%, and end-to-end P95 latency is at most eight seconds. Generated images and reports are transient and must not be committed.
