...
- **Phase 3 shipped (2026-07-12, #440 — registry #441, routing #446, control-plane split #463/#479).**
  ...
  `RoleMapper` scope-enforcement exceptions, fails closed for MyBatis batch executors, and is architecture-checked
  against tenant-table references. Direct reads remove per-JVM TTL divergence for newly installed scopes;
