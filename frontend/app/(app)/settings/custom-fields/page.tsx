...
/**
 * The retired address for custom field definitions (#1340 WS4.6).
 *
 * The job now lives at the `custom-fields` section of CRM configuration, and this path forwards there permanently rather than 404ing an
...
export default async function CustomFieldsSettingsPage({
    ...
    permanentRedirect(settingsRedirectTarget("workspace.custom-fields", await searchParams));
}
