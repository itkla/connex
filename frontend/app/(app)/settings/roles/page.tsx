...
/**
 * The retired address for workspace roles and what each may do (#1340 WS4.6).
 *
 * The job now lives at the `roles` section of People & access, and this path forwards there permanently rather than 404ing an
...
export default async function RolesSettingsPage({
    ...
    permanentRedirect(settingsRedirectTarget("workspace.roles", await searchParams));
}
