...
/**
 * The retired address for the workspace member roster (#1340 WS4.6).
 *
 * The job now lives at the `members` section of People & access, and this path forwards there permanently rather than 404ing an
...
export default async function MembersSettingsPage({
    ...
    permanentRedirect(settingsRedirectTarget("workspace.members", await searchParams));
}
