...
/**
 * The retired address for workspace diagnostics (#1340 WS4.6).
 *
 * The job now lives at the `diagnostics` section of Audit & diagnostics, and this path forwards there permanently rather than 404ing an
...
export default async function DiagnosticsSettingsPage({
    ...
    permanentRedirect(settingsRedirectTarget("workspace.diagnostics", await searchParams));
}
