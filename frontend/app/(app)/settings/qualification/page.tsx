...
/**
 * The retired address for qualification criteria (#1340 WS4.6).
 *
 * The job now lives at the `qualification` section of CRM configuration, and this path forwards there permanently rather than 404ing an
...
export default async function QualificationSettingsPage({
    ...
    permanentRedirect(settingsRedirectTarget("workspace.qualification", await searchParams));
}
