...
/**
 * The retired address for Goals, before Reports moved under Insights (#1323 WS4).
 *
 ...
 */
export default async function LegacyGoalsPage({
    searchParams,
}: {
    searchParams: Promise<RouteSearchParams>;
}) {
    permanentRedirect(movedRouteTarget("/overview/reports/goals", await searchParams));
}
