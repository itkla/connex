...
/**
 * The retired address for the organization’s own identity (#1340 WS4.6).
 *
 * The job now lives at the `identity` section of organization General, and this path forwards there permanently rather than 404ing an
...
export default async function OrganizationOverviewPage({
    ...
    permanentRedirect(settingsRedirectTarget("organization.overview", await searchParams));
}
