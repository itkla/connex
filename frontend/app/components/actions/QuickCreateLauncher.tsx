            ...
            {mounted && activeIsMobile ? (
                ...
                >
                    <DrawerContent
                        ...
                        className={cn(
                            'gap-0 p-0 transition-[transform,max-height,width,margin,border-radius] duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] data-ending-style:duration-(--motion-standard)',
                            expanded
