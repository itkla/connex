...
const HONEST_ROUTE_READS = [
    ...
    ['app/(app)/insights/analytics/page.tsx', 'getRecentMovesFromCookie'],
    ['app/(app)/dashboard/page.tsx', 'getUpcomingTasksFromCookie(cookie, 4).catch'],
    ['app/(app)/dashboard/page.tsx', 'getUsers(init).catch'],
    ...
    ['app/(app)/insights/reports/page.tsx', 'getReportsFromCookie'],
    ['app/(app)/insights/reports/page.tsx', 'getReportTemplatesFromCookie'],
    ['app/(app)/insights/reports/new/page.tsx', 'getReportTemplatesFromCookie'],
    ['app/(app)/insights/reports/new/page.tsx', 'getPipelinesFromCookie'],
    ['app/(app)/insights/reports/new/page.tsx', 'getTagsFromCookie'],
    ['app/(app)/insights/reports/[id]/edit/page.tsx', 'getPipelinesFromCookie'],
    ['app/(app)/insights/reports/[id]/edit/page.tsx', 'getTagsFromCookie'],
] as const;
