...
/**
 * Token-addressed invite-link endpoints used by the accept screen. Preview is open to any
 * authenticated user holding the token; redeeming joins the workspace and pins it as active.
 */
@RestController
...
public class InviteLinkController {
    ...
    public InviteLinkPreviewDto preview(@PathVariable String token) {
        return inviteLinkService.previewLink(token);
    }
