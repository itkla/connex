...
public class TenantScopeInterceptor implements Interceptor {
    ...
    private static final Set<String> EXEMPT_STATEMENTS = Set.of(
        ...
        MAPPERS + "AiChatMapper.clearSessionOwnershipForUser",
        MAPPERS + "AiChatMapper.clearMessageAuthorsForUser",
        MAPPERS + "AiChatMapper.clearToolCallExecutorsForUser",
        MAPPERS + "AiChatMapper.clearTurnRequestersForUser",
        MAPPERS + "AiChatMapper.deleteParticipantsForUserAnywhere",
        MAPPERS + "AiChatMapper.clearSessionOwnershipAnywhere",
