...
final class AiReportFacts {
    ...
    private static final Map<String, String> ENGLISH_LABELS = Map.ofEntries(
            ...
            Map.entry("quote_count", "Quote volume"),
            Map.entry("quote_issue_rate", "Quote issue rate"),
            Map.entry("document_to_win_rate", "Document-to-win rate"),
            Map.entry("approval_decision_count", "Approval decisions"),
            Map.entry("approval_cycle_days", "Approval cycle days"),
            Map.entry("effective_discount_percent", "Effective discount (won)"),
            Map.entry("open_discount_percent", "Effective discount (open)"),
    ...
    private static final Map<String, String> JAPANESE_LABELS = Map.ofEntries(
            ...
            Map.entry("avg_cycle_days", "平均案件日数"),
            Map.entry("open_pipeline_value", "進行中パイプライン金額"),
            Map.entry("open_deal_count", "進行中案件数"),
            ...
            Map.entry("quote_count", "見積作成数"),
            Map.entry("quote_issue_rate", "見積確定率"),
            Map.entry("document_to_win_rate", "書類からの受注率"),
            Map.entry("approval_decision_count", "承認決裁数"),
            Map.entry("approval_cycle_days", "承認所要日数"),
            Map.entry("effective_discount_percent", "実効値引率（受注）"),
            Map.entry("open_discount_percent", "実効値引率（進行中）"),
