...
public class DuplicatePreflightProperties {
    ...
    private int maxWorkflowCredits = 10_000;
    private Duration reviewProofTtl = Duration.ofMinutes(30);
    ...
    public int getMaxWorkflowCredits() {
        return maxWorkflowCredits;
    }

    public void setMaxWorkflowCredits(int maxWorkflowCredits) {
        this.maxWorkflowCredits = maxWorkflowCredits;
    }

    public Duration getReviewProofTtl() {
        return reviewProofTtl;
    }

    public void setReviewProofTtl(Duration reviewProofTtl) {
        this.reviewProofTtl = reviewProofTtl;
    }
    ...
    void validate() {
        if (maxRequestsPerMinute < 1
                ...
                || maxRateLimitKeys < 1
                || maxWorkflowCredits < 1
                || reviewProofTtl == null
                || reviewProofTtl.isZero()
                || reviewProofTtl.isNegative()
                || reviewProofTtl.toSeconds() < 1) {
