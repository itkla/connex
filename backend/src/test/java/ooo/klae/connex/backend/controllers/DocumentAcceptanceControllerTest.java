...
class DocumentAcceptanceControllerTest {
    ...
    void previewReadsTheGrantCookieOnly() throws Exception {
        ...
        verify(acceptanceService).preview(LINK, SOURCE);
    }
