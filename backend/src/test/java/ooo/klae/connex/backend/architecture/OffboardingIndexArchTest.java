...
class OffboardingIndexArchTest {
    ...
    private static final List<String[]> REQUIRED_LEADING_INDEXES = List.of(
        ...
        new String[] {"duplicate_review_decision", "dismissed_by_user_id"},
        ...
        new String[] {"record_comment", "author_user_id"},
        ...
        new String[] {"team", "manager_user_id"},
        new String[] {"team_member", "user_id"});
